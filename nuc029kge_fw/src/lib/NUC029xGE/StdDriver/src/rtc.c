 ...
 * $Revision: 9 $
 * $Date: 16/10/25 4:25p $
 * @brief    NUC029xGE series Real Time Clock(RTC) driver source file
 *
 * @note
...
/**
  ...
  *
  * @param[in]  u32FrequencyX100    Specify the RTC clock X100, ex: 3277365 means 32773.65.
  *
  * @return     None
  *
...
void RTC_32KCalibration(uint32_t u32FrequencyX100)
{
    ...
    */
    fFactor = (float)3276800 / u32FrequencyX100;
    u32Freqadj = (uint32_t)(0x200000 * fFactor);

    RTC_WaitAccessEnable();
    RTC->FREQADJ = u32Freqadj;
}
...
{
    RTC_WaitAccessEnable();
    RTC->CAMSK = (u8IsTenYMsk << RTC_CAMSK_MTENYEAR_Pos) |
...
{
    RTC_WaitAccessEnable();
    RTC->TAMSK = (u8IsTenHMsk << RTC_TAMSK_MTENHR_Pos) |
