 ...
 * $Revision: 6 $
 * $Date: 16/10/25 4:25p $
 * @brief    NUC029xGE series ADC driver source file
 *
 * @note
...
/**
  ...
  * @return  None
  * @note NUC029xGE series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
