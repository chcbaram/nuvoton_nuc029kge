 ...
 * $Revision: 8 $
 * $Date: 16/10/25 4:25p $
 * @brief    NUC029xGE series Timer Controller(Timer) driver source file
 *
 * @note
...
/**
  ...
  *
  * @param[in]  timer           The pointer of the specified Timer module. It could be TIMER0, TIMER1, TIMER2, TIMER3.
  * @param[in]  u32DropCount    This parameter has no effect in NUC029xGE series BSP.
  * @param[in]  u32Timeout      This parameter has no effect in NUC029xGE series BSP.
